...
const PUBLIC_PATHS = ['/login', '/signup', '/auth/callback', '/api/chat-embed', '/api/transcribe-embed', '/api/affirmation-embed', '/api/session-summary-embed', '/api/voice-embed', '/api/admin-embed', '/api/intake-embed'];
